...
ActiveRecord::Schema.define(version: 20170425095039) do
  ...
  create_table "locations", force: :cascade do |t|
    ...
    t.float    "long"
    t.string   "address"
    t.index ["supplier_id"], name: "index_locations_on_supplier_id", using: :btree
  end
  ...
  create_table "resources", force: :cascade do |t|
    ...
    t.index ["location_id"], name: "index_resources_on_location_id", using: :btree
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "verified_by_admin_user_id"
    t.decimal  "lat"
    t.decimal  "long"
    t.string   "three_words"
