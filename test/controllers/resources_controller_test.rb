...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resource" do
    assert_difference('Resource.count') do
      post resources_url, params: { resource: { stock: @resource.stock, type: @resource.type, units: @resource.units } }
    end
  ...
  test "should update resource" do
    patch resource_url(@resource), params: { resource: { stock: @resource.stock, type: @resource.type, units: @resource.units } }
